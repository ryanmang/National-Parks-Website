...
public class Park {
	...
	public double getMilesTrail() {
		return milesTrail;
	}

	public void setMilesTrail(double milesTrail) {
		this.milesTrail = milesTrail;
	}
	...
	public void setNumberSites(int numberSites) {
